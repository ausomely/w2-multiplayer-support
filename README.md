...
![Current Design with the interface of finding games](Interface/FindGame.png)

![Current Design with the interface of waiting for a game to start](Interface/WaitInLobby.png?)
