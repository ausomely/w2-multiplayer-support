...
void CCursorSet::DrawCursor(std::shared_ptr<CGraphicSurface> surface, int xpos,
                            int ypos, int cursorindex)
{
    ...
    DrawTile(surface, xpos - DCursorXPoint[cursorindex],
             ypos - DCursorYPoint[cursorindex], cursorindex);
}
