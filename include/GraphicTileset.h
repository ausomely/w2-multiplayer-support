...
class CGraphicTileset
{
  protected:
    ...
    static bool ParseGroupName(const std::string &tilename,
  ...
  public:
    ...
    bool DuplicateTile(int destindex, const std::string &tilename,
                       int srcindex);
    bool DuplicateClippedTile(int destindex, const std::string &tilename,
    ...
    void DrawTile(std::shared_ptr<CGraphicSurface> surface, int xpos, int ypos,
                  int tileindex);

    void DrawClipped(std::shared_ptr<CGraphicSurface> surface, int xpos,
                     int ypos, int tileindex, uint32_t rgb);
};
