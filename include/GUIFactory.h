...
class CGUIFactory
{
  ...
  public:
    static std::shared_ptr<CGUIApplication> ApplicationInstance(
        const std::string &appname = "");
    static std::shared_ptr<CGUIDisplay> DefaultDisplay();
    static std::shared_ptr<CGUIDrawingArea> NewDrawingArea();
    static std::shared_ptr<CGUIBox> NewBox(CGUIBox::EOrientation orientation,
                                           int spacing);
    ...
    static std::shared_ptr<CGUIFileChooserDialog> NewFileChooserDialog(
        const std::string &title, bool openfile,
        std::shared_ptr<CGUIWindow> parent);
};
