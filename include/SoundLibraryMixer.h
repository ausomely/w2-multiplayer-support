...
class CSoundLibraryMixer
{
  ...
  public:
    ...
    static int TimestepCallback(const void *in, void *out, unsigned long frames,
                                const PaStreamCallbackTimeInfo *timeinfo,
                                PaStreamCallbackFlags status, void *data);
    int Timestep(void *out, unsigned long frames,
                 const PaStreamCallbackTimeInfo *timeinfo,
    ...
    int PlayTone(float freq, float freqdecay, float volume, float volumedecay,
                 float rightbias, float rightshift);
