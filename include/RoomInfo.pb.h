...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_RoomInfo_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_RoomInfo_2eproto {
...
class RoomInformation final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RoomInfo.RoomInformation) */ {
 public:
  RoomInformation();
  ...
  inline RoomInformation* New() const final {
    return CreateMaybeMessage<RoomInformation>(nullptr);
  }
 ...
 private:
  ...
  bool active_;
  friend struct ::TableStruct_RoomInfo_2eproto;
};
// -------------------------------------------------------------------

class RoomInfoPackage final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RoomInfo.RoomInfoPackage) */ {
 public:
  RoomInfoPackage();
  ...
  inline RoomInfoPackage* New() const final {
    return CreateMaybeMessage<RoomInfoPackage>(nullptr);
  }
