...
class CSoundClip{
    protected:
        ...
        static bool ChannelInputEvent(std::shared_ptr<CIOChannel> channel, SIOEventType &event, TIOCalldata data);
    ...
    public:
        ...
        bool Load(std::shared_ptr< CDataSource > source, bool ismp3 = false, bool asynchload = true);
