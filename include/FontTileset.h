...
class CFontTileset : public CGraphicMulticolorTileset
{
  ...
  public:
    ...
    bool LoadFont(std::shared_ptr<CGraphicRecolorMap> colormap,
    ...
    void DrawText(std::shared_ptr<CGraphicSurface> surface, int xpos, int ypos,
                  const std::string &str);
    void DrawTextColor(std::shared_ptr<CGraphicSurface> surface, int xpos,
                       int ypos, int colorindex, const std::string &str);
    void DrawTextWithShadow(std::shared_ptr<CGraphicSurface> surface, int xpos,
                            int ypos, int color, int shadowcol, int shadowwidth,
                            const std::string &str);
    void MeasureText(const std::string &str, int &width, int &height);
    void MeasureTextDetailed(const std::string &str, int &width, int &height,
                             int &top, int &bottom);
};
