...
class CMultiPlayerOptionsMenuMode : public CButtonMenuMode
{
  protected:
    ...
    static void HostMultiPlayerButtonCallback(
        std::shared_ptr<CApplicationData> context);
    static void JoinMultiPlayerButtonCallback(
        std::shared_ptr<CApplicationData> context);
    static void MainMenuButtonCallback(
        std::shared_ptr<CApplicationData> context);

    CMultiPlayerOptionsMenuMode(const CMultiPlayerOptionsMenuMode &) = delete;
    const CMultiPlayerOptionsMenuMode &operator=(
        const CMultiPlayerOptionsMenuMode &) = delete;
