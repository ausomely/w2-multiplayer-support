...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_LoginInfo_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_LoginInfo_2eproto {
...
class Credential final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:LoginInfo.Credential) */ {
 public:
  Credential();
  virtual ~Credential();
 ...
 private:
  ...
  friend struct ::TableStruct_LoginInfo_2eproto;
};
// ===================================================================
