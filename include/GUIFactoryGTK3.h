...
class CGUIApplicationGTK3 : public CGUIApplication
{
  ...
  public:
    ...
    virtual void SetActivateCallback(TGUICalldata calldata,
                                     TGUIApplicationCallback callback) override;
    virtual void SetTimer(int timems, TGUICalldata calldata,
                          TGUITimeoutCallback callback) override;
...
class CGUIWidgetGTK3 : public virtual CGUIWidget,
                       public std::enable_shared_from_this<CGUIWidget>
{
  protected:
    GtkWidget *DWidget;
    ...
    static gboolean ButtonPressEventCallback(GtkWidget *widget,
                                             GdkEventButton *event,
                                             gpointer data);
    static gboolean ButtonReleaseEventCallback(GtkWidget *widget,
                                               GdkEventButton *event,
                                               gpointer data);
    static gboolean DeleteEventCallback(GtkWidget *widget, GdkEvent *event,
                                        gpointer data);
    static void DestroyEventCallback(GtkWidget *widget, gpointer data);
    static gboolean MotionNotifyEventCallback(GtkWidget *widget,
                                              GdkEventMotion *event,
                                              gpointer data);
    static gboolean KeyPressEventCallback(GtkWidget *widget, GdkEventKey *event,
                                          gpointer data);
    static gboolean KeyReleaseEventCallback(GtkWidget *widget,
                                            GdkEventKey *event, gpointer data);
    static gboolean ExposeEventCallback(GtkWidget *widget,
                                        GdkEventExpose *event, gpointer data);
    static gboolean ConfigureEventCallback(GtkWidget *widget,
                                           GdkEventConfigure *event,
                                           gpointer data);
    static gboolean DrawEventCallback(GtkWidget *widget, cairo_t *cr,
                                      gpointer data);
  ...
  public:
    ...
    virtual std::shared_ptr<CGraphicSurface> CreateSimilarSurface(
        int width, int height) override;
    virtual std::shared_ptr<CGraphicResourceContext> CreateResourceContext()
        override;

    virtual void EnableEvent(EGUIEvent event) override;
    virtual void DisableEvent(EGUIEvent event) override;

    virtual void SetActivateEventCallback(
        TGUICalldata calldata, TGUIActivateEventCallback callback) override;
    virtual void SetButtonPressEventCallback(
        TGUICalldata calldata, TGUIButtonEventCallback callback) override;
    virtual void SetButtonReleaseEventCallback(
        TGUICalldata calldata, TGUIButtonEventCallback callback) override;
    virtual void SetDeleteEventCallback(
        TGUICalldata calldata, TGUIDeleteEventCallback callback) override;
    virtual void SetDestroyEventCallback(
        TGUICalldata calldata, TGUIDestroyEventCallback callback) override;
    virtual void SetMotionEventCallback(
        TGUICalldata calldata, TGUIMotionEventCallback callback) override;
    virtual void SetKeyPressEventCallback(
        TGUICalldata calldata, TGUIKeyEventCallback callback) override;
    virtual void SetKeyReleaseEventCallback(
        TGUICalldata calldata, TGUIKeyEventCallback callback) override;
    virtual void SetExposeEventCallback(
        TGUICalldata calldata, TGUIConfigureEventCallback callback) override;
    virtual void SetConfigureEventCallback(
        TGUICalldata calldata, TGUIConfigureEventCallback callback) override;
    virtual void SetDrawEventCallback(TGUICalldata calldata,
                                      TGUIDrawEventCallback callback) override;
};
...
class CGUIDrawingAreaGTK3 : public virtual CGUIDrawingArea,
                            public CGUIWidgetGTK3
{
  public:
...
class CGUIBoxGTK3 : public virtual CGUIBox, public CGUIContainerGTK3
{
  public:
    ...
    void PackStart(std::shared_ptr<CGUIWidget> widget, bool expand, bool fill,
                   int padding) override;
    void PackEnd(std::shared_ptr<CGUIWidget> widget, bool expand, bool fill,
                 int padding) override;
};
...
class CGUIWindowGTK3 : public virtual CGUIWindow, public CGUIContainerGTK3
{
  public:
    ...
    void SetMinSize(std::shared_ptr<CGUIWidget> widget, int width,
                    int height) override;
    void SetMaxSize(std::shared_ptr<CGUIWidget> widget, int width,
                    int height) override;
...
class CGUIFileChooserDialogGTK3 : public virtual CGUIFileChooserDialog,
                                  public CGUIWindowGTK3
{
  public:
