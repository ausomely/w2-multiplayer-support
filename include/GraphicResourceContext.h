...
class CGraphicResourceContext
{
  public:
    ...
    virtual void SetSourceSurface(std::shared_ptr<CGraphicSurface> srcsurface,
                                  int xpos, int ypos) = 0;
    ...
    virtual void Clip() = 0;
    virtual void MaskSurface(std::shared_ptr<CGraphicSurface> srcsurface,
                             int xpos, int ypos) = 0;

    virtual std::shared_ptr<CGraphicSurface> GetTarget() = 0;
    virtual void Save() = 0;
    virtual void Restore() = 0;
    virtual void DrawSurface(std::shared_ptr<CGraphicSurface> srcsurface,
                             int dxpos, int dypos, int width, int height,
                             int sxpos, int sypos) = 0;
    virtual void CopySurface(std::shared_ptr<CGraphicSurface> srcsurface,
                             int dxpos, int dypos, int width, int height,
                             int sxpos, int sypos) = 0;
};
